...
class ConfirmationDeposit extends StatefulWidget {
  ...
  @override
  State<ConfirmationDeposit> createState() => _ConfirmationDepositState();
}

class _ConfirmationDepositState extends State<ConfirmationDeposit> {
